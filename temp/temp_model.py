...
class Generator(nn.Module):
    def __init__(self, in_channels=3, out_channels=3, n_feats=64, n_blocks=6, img_size=256):
...
class Discriminator(nn.Module):
    def __init__(self, in_channels=3, n_feats=64, n_layers=5):
...
if __name__ == "__main__":
    generator = Generator(in_channels=3, out_channels=3, n_feats=64, n_blocks=6, img_size=256)
